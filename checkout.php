...
<body>
    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-lg-8">
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Form Penyewaan</span></h5>
                <div class="bg-light p-30 mb-5">
                    <form method="POST" action="checkout2.php"
					<div class="row">					
                        <div class="col-md-6 form-group">
                            <label>Nama Lengkap Sesuai KTP</label>
                            <input class="form-control" type="text" placeholder="Andra" name="inputname">
                        </div>                                                
                        <div class="col-md-6 form-group">
                            <label>No HP Aktif</label>
                            <input class="form-control" type="text" placeholder="+62831234567" name="inputphone">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Alamat</label>
                            <input class="form-control" type="text" placeholder="Jl. Pisang RT 04 Rw 05, Kelapa Dua, Kebon Jeruk 11550" name="inputname">
                        </div>
						<div class="col-md-6 form-group">                            
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Tanggal Mulai Sewa</label>
                            <input class="form-control" type="text" placeholder="09-11-2022">
                        </div>
                        <div class="col-md-6 form-group">
